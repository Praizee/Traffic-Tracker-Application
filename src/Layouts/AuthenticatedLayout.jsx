        ...
        <Layout className="!max-w-screen !min-h-screen !bg-white">
          ...
          >
            ...
            >
              ...
              <Menu.Item
                key="7"
                icon={<MdOutlineHistory className="w-4 h-4" />}
              >
                <Link to="trip-history">Trip History</Link>
              </Menu.Item>
            ...
            <Header className="border-b-2 fixed z-[1000] w-full p-0 bg-white flex items-cente">
              ...
              >
                ...
                <div className="flex gap-4 justify-between md:justify-normal lg:flex-none">
                  {/* notification */}
                  <div className="dropdown dropdown-end mt-1.5 hidden md:block">
                    <div
                      tabIndex={0}
                      role="button"
                  ...
                  {/* notification */}
                  <div className="dropdown dropdown-end mt-1.5 md:hidden block">
                    <div
                      tabIndex={0}
                      role="button"
                      className="btn btn-ghost btn-circle avatar"

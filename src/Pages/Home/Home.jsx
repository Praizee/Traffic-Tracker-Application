          ...
          <div className="flex flex-col gap-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-max">
              ...
              <div className="bg-[#F5F8FF] flex gap-2 justify-between p-4 rounded-md">
                ...
                <p className="text-[#E83B05] font-semibold text-[20px]">
                  34 °C
                </p>
              </div>
              <div className="bg-[#F5F8FF] flex gap-2 justify-between p-4 rounded-md">
              ...
              <div className="pt-6 md:pl-6 pr-6 md:pr-0 pb-6 md:pb-0 md:flex gap-4">
                ...
                <span className="space-y-2">
                  ...
                  <p className="text-[#848484] text-[12px] font-normal pl-3 md:pl-0">
                    Local residents expressed frustration and inconvenience due
                    to the unexpected road block, with some taking to social
                    media platforms to share updates and vent about the
                    situation.
                  </p>
                  <button
                    type="button"

...
const Login = () => {
  ...
  return (
    ...
    <main className="w-full lg:px-12 md:px-5 md:pt-10 pt-16 px-4 bg-[#6386B0] bg-cover bg-center min-h-screen flex flex-col items-center justify-center sm:px-4">
      <div className="w-full space-y-6 text-[#67749680] sm:max-w-md">
        <div className="">
          <div className="mt-5 space-y-2">
            ...
            <p className="text-white">Time to Beat Lagos Traffic again?</p>
          </div>
          ...
          >
            ...
            <div className="text-white text-sm">
              <p>
                ...
                <span className="text-[#EB5757] text-sm link link-hover font-semibold">
                  Condition of Use
                </span>{" "}
                and{" "}
                <span className="text-[#EB5757] text-sm link link-hover font-semibold">

                ...
                <div className="">
                    <div className="mt-5 space-y-2">
                        ...
                        <p className="text-white">
                            Time to Beat Lagos Traffic again?
                        </p>
                    </div>
                ...
                <div className="bg-white/5 shadow-lg p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    ...
                    >
                        ...
                        <div className="text-white text-sm">
                            <p>
                                By creating an account, you agree to Traffic Tracker’s <span className="text-[#EB5757] text-sm link link-hover font-semibold">Condition of Use</span> and <span className="text-[#EB5757] text-sm link link-hover font-semibold">Privacy Notice</span>.
                            </p>
                        </div>

                        <div className="relative">
                            <span className="block w-full h-px bg-gray-300"></span>
                            <p className="inline-block w-fit text-sm bg-white text-gray-400 px-2 absolute -top-2 inset-x-0 mx-auto">Or use</p>
                        </div>

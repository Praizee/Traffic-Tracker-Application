                ...
                <div className="bg-white/5 shadow-lg p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    ...
                    >
                        ...
                        <div className="text-white">
                            <p>
                                By creating an account, you agree to Traffic Tracker’s <span className="text-[#EB5757] link link-hover font-semibold">Condition of Use</span> and <span className="text-[#EB5757] link link-hover font-semibold">Privacy Notice</span>.
                            </p>
                        </div>
